...
@objc public protocol CosmosDelegate:NSObjectProtocol {
    @objc optional func didTouchCosmos(rating: Double)
    ...
    @objc optional func didFinishTouchingCosmos(rating: Double)
}
...
@IBDesignable open class CosmosView: UIView {
    @objc public weak var delegate:CosmosDelegate?;
    /**
    ...
    @objc open var settings = CosmosSettings() {
        didSet {
            update()
        }
    }
    ...
    open override func accessibilityIncrement() {
        ...
        delegate?.didTouchCosmos?(rating:rating);
        delegate?.didFinishTouchingCosmos?(rating:rating);
    }
  ...
  // @objc open func didTouchCosmos(rating:Double){}
    /// Closure will be called when the user lifts finger from the cosmos view. The touch rating argument is passed to the closure.
   //@objc open func didFinishTouchingCosmos(rating:Double){}
    ...
    func onDidTouch(_ locationX: CGFloat) {
        ...
        delegate?.didTouchCosmos?(rating:calculatedTouchRating)
